# Class Users::Admins::MeetingsController provides <description>
#
# @author Piyush Wani <piyush.wani@amuratech.com>
#
class Users::Admins::MeetingsController < ApplicationController
  ...
  def update
    redirect_to(users_admins_meetings_path) && return if @meeting.update(meeting_params)
    render 'edit'
  end
